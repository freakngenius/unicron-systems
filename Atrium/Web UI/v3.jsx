...
const V3_FILTER_PRESETS = {
  now: [
    ...
    { label: "Priority", defaultOpen: true, badge: 2, items: [
      { label: "P0 — Critical", dot: "#D14848", count: 2, checked: true },
      { label: "P1 — High", dot: "#D97757", count: 7, checked: true },
      { label: "P2 — Medium", dot: "#C9A227", count: 11 },
      { label: "P3 — Low", dot: "#7C87A0", count: 6 },
    ]},
    { label: "Status", items: [
      { label: "Open", count: 18 },
  ...
  work: [
    ...
    { label: "Priority", items: [
      { label: "P0 — Critical", dot: "#D14848", count: 3 },
      { label: "P1 — High", dot: "#D97757", count: 9 },
      { label: "P2 — Medium", dot: "#C9A227", count: 14 },
      { label: "P3 — Low", dot: "#7C87A0", count: 8 },
    ]},
    { label: "Stage", items: [
