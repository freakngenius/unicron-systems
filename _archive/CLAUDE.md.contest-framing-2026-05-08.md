Archived 2026-05-08. Replaced by current CLAUDE.md after pivot away from the Perplexity Billion Dollar Build contest framing toward the fundraising posture (Pathfinder + Metacron + Internal Org Atrium nervous system, Zedcor customer-zero, 2-person team plus Claude Code as third teammate).

Kept verbatim for reference: the contest-rules language, Phase 1 Foundation Sprint discovery framing, and the Top 3 vertical candidates ranking. Some of this material may be useful as historical context for fundraising narrative (what we explored, why we picked the path we did, what we ruled out).
