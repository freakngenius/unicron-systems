// Inline-loaded fixture content. The same .md file is read by the test
// suite via Node fs; importing it as a TS literal keeps the dev page
// self-contained and avoids a bundler raw-loader dance.

const FIXTURE = `## Top 8 leads near Calgary in the last 7 days
