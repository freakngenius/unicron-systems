        ...
        {sentTo ? (
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-accent-primary text-white mono text-[12px] tracking-[0.10em] uppercase py-3 px-5 rounded-md hover:bg-accent-primary/90 transition-colors"
            >
